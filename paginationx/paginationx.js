...
function paginationXDirective($filter, $compile) {
	...
	/**
	 * compileFn - The compile function for paginationX directive.
	 * @param  {[type]} elem  [The directive element]
	 * @param  {[type]} attrs [Attributes of the directive element]
	 * @return {[type]}       [Returns the link function with pre and post]
	 */
	function compileFn(elem, attrs) {
		return {

			/**
			 * preLink - The Pre Link function for the paginationX directive. This creates the table dynamically and replces the <table></table>
		...
		}; // return statement inside compileFn ends
	} // compileFn ends
}