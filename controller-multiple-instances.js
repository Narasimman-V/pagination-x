...
hrapp.controller('HRAppController',['$scope','$rootScope','$http','$q','$location','$filter',function($scope, $rootScope, $http, $q, $location, $filter ) {
	...
	$scope.employees = [
		...
		{"Sno":1,"firstname":"Michelle","lastname":"Fisher","jobtitle":"HRD/Training and Development Administrator","county":"Summerbush","countyStyle":"color:red","city":"East Pepperell","email":"michelle.fisher@kmail.com","mobile":815231416,selectable:false,actions:[{label:"Edit", name:"Edit", type:"Button", htmlAttrbs:'id="abc" class="def"'},{label:"Delete", name:"Delete", type:"Button", htmlAttrbs:'id="ijk" class="lmn"'}]},
...
/////////////////////////////////////////////////////////////////// Instance 2 ///////////////////////////////////////////////////////////////////////////
	...
	$scope.exportOptions2 = [
		{type:"pdf",records:"page",columns:pdfExportColumns2,fileName:"Employee-Roster-Report",label:"PdfPage",style:pdfExportStyle,header:'Employee Report'},
		{type:"pdf",records:"all",columns:pdfExportColumns2,fileName:"Employee-Roster-Report",label:"PdfAll",style:pdfExportStyle,header:'Employee Report'},
		{type:"pdf",records:"selected",columns:pdfExportColumns2,fileName:"Employee-Roster-Report",label:"Pdf",style:pdfExportStyle,header:'Employee Report'},
		{type:"excel",records:"page",columns:excelExportColumns2,fileName:"EmployeeRoster",label:"XLPage"},
		{type:"excel",records:"all",columns:excelExportColumns2,fileName:"EmployeeRoster",label:"XLAll"},
		{type:"excel",records:"selected",columns:excelExportColumns2,fileName:"EmployeeRoster",label:"XL"},
	];
